...
public class SelfTest extends Command {
    ...
    public void execute(){
        ...
        arm.setShootPos(Constants.Positions.amp);
        while (!arm.isReady()) Timer.delay(1);
        System.out.println("Testing Podium Position...");
        arm.setShootPos(Constants.Positions.podium);
        while (!arm.isReady()) Timer.delay(1);
        System.out.println("Testing Subwoofer Position...");
        arm.setShootPos(Constants.Positions.subwoofer);
